...
use PHPCSDevTools\Tests\Scaffold\Resolver\NamespaceResolver\UnitTestNamespaceResolverTest;

/**
 * Resolves the namespace for a unit test class.
 *
 * @see UnitTestNamespaceResolverTest
 */
final class UnitTestNamespaceResolver implements UnitTestNamespaceResolverInterface
{
    ...
    /**
     * Create a new unit test namespace resolver instance.
     *
    ...
    /**
     * Resolve the namespace for a unit test class.
     *
    ...
    public function resolve(DotSeparatedSniffInterface $dotSeparatedSniff)
    {
        ...
        return \implode('\\', [$namespace, 'Tests', $dotSeparatedSniff->getCategory()->toString()]);
    }
}
