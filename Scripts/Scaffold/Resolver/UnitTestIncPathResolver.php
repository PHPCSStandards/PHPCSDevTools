...
use PHPCSDevTools\Tests\Scaffold\Resolver\PathResolver\UnitTestIncPathResolverTest;

/**
 * Resolves the fixture file path for a sniff.
 *
 * @see UnitTestIncPathResolverTest
 */
final class UnitTestIncPathResolver implements UnitTestIncPathResolverInterface
{
    ...
    /**
     * Create a new UnitTestIncPathResolver instance.
     *
    ...
    /**
     * Resolve the fixture file path for a sniff.
     *
    ...
    public function resolve(DotSeparatedSniffInterface $dotSeparatedSniff)
    {
        return \implode(\DIRECTORY_SEPARATOR, [
            ...
            $dotSeparatedSniff->getSniff()->toString() . 'UnitTest.inc',
        ]);
    }
}
